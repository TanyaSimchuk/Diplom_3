...
public class ExitProfileTest {
    ...
    @Test
    @DisplayName("Check pushing exit button from user profile")
    @Description("Проверка нажатия кнопки Выход из личного профиля")
    public void checkPushExitButtonFromUserProfile() {
        ...
        mainPage.userAuthorized().clickExitButton();

        assertTrue("Не показана форма авторизации", mainPage.userRegistration().checkLoginFormIsVisible());
    }
    @After
