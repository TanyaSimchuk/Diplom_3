...
public class PushConstructorFromProfileTest {
    ...
    @Test
    @DisplayName("CHeck push constructor from profile")
    @Description("Проверка нажатия кнопки Конструктор из личного профиля")
    public void checkPushConstructorFromUserProfile() {
