...
public class PushLogoFromProfileTest {
    ...
    @Test
    @DisplayName("Check pushing logo from user profile")
    @Description("Проверка нажатия логотипа сайта из личного профиля")
    public void checkPushLogoFromUserProfile() {
        ...
        mainPage.userAuthorized().clickLogo();
