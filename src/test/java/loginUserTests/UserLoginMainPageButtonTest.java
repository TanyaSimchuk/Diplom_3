...
public class UserLoginMainPageButtonTest {
    ...
    @Test
    @DisplayName("Login user by Login button on main page")
    @Description("Авторизация юзера через кнопку Войти в аккаунт на главной странице")
