...
public class LoginFromRegFormTest {
    ...
    @Test
    @DisplayName("Login user by Login button on reg form")
    @Description("Авторизация юзера через кнопку Войти на странице регистрации")
    public void checkLoginByLoginButtonOnRegForm() {
