...
public class UserLoginPrivateCabinetTest {
    ...
    @Test
    @DisplayName("Login user by private cabinet button")
    @Description("Авторизации юзера через кнопку Личный кабинет")
    public void checkLoginByPrivateCabinetButton() {
        ...
        mainPage.open()
                .userLogin().clickPersonalCabinet()
                .inputEmail(email)
